...
import (
	...
	v1alpha1 "github.com/GoogleCloudPlatform/cloud-run-events/pkg/client/listers/events/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventsV1alpha1().GCSSources(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventsV1alpha1().GCSSources(namespace).Watch(options)
			},
		},
		&eventsv1alpha1.GCSSource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gCSSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventsv1alpha1.GCSSource{}, f.defaultInformer)
}
